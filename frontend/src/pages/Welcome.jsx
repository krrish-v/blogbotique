...
function Welcome() {
    ...
    return (
        <div className="h-screen w-screen flex flex-col justify-center items-center">
            ...
            <h1 className="mt-10 py-1 font-poppins font-extrabold text-3xl tracking-normal"> Welcome to Scribbs</h1>
            ...
            <div className="mt-6 h-3/5 w-1/4 min-w-40 px-10 border-2 border-custom-gray rounded-3xl drop-shadow-xl flex flex-col items-center">
                ...
                <p className="p-5 font-poppins text-center">How to create a amazing blog using Scribbs</p>
